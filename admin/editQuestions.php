<?php
	...
	$editRowID = $_POST['rowID'];
	$editQuestion = mysqli_real_escape_string($dbc, trim($_POST['editQuestion']));
	$editQuestionDescription = mysqli_real_escape_string($dbc, trim($_POST['editQuestionDescription']));
	
	$query = "UPDATE questions SET question = '$editQuestion', description = '$editQuestionDescription' WHERE questionID = '$editRowID'";
